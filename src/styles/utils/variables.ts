export const palette = {
  ...
  tertiary: "hsla(203, 36%, 18%, 1)",
  quaternary: "hsla(196, 41%, 11%, 1)",
  contrast: "hsla(33, 38%, 59%, 1)",
  black: "hsla(0, 0%, 0%, 1)",
  white: "hsla(0, 0%, 100%, 1)",
  // primary: "hsla(9, 51%, 39%, 1)",
  // secondary: "hsla(2, 40%, 29%, 1)",
  // tertiary: "hsla(0, 37%, 25%, 1)",
  // quaternary: "hsla(0, 20%, 18%, 1)",
  // contrast: "hsla(193, 32%, 13%, 1)",
